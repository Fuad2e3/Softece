...
Payments workflow: Clients choose between *Pay after Discussion* (free consultation, advance after scope lock), *bKash (Send Money)*, *Nagad (Send Money)*, or *Bank Transfer*. Upon submission, a post-order payment receipt card provides 1-click bKash/Nagad number copying (`01902780443`), instant WhatsApp confirmation with pre-filled order details, and late TrxID logging directly to the sheet.
